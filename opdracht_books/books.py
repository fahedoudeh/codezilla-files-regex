with open("Dopamine nation.txt", "w") as file:
    file.write("""
...
def procces_books():
    with open("/home/rogmint/OneDrive/Documents/codezilla/files_regex/opdracht_books/Dopamine nation.txt") as file:
        dopamine_book = file.readlines() 
    with open("/home/rogmint/OneDrive/Documents/codezilla/files_regex/opdracht_books/new_opamine_nation.txt", "w") as file:
        for line in dopamine_book:
            opdracht = line[::-1].upper()
            file.write(opdracht)   
